                ...
                <div className="layout-content-container flex flex-col max-w-[1200px] flex-1 gap-6">
                            ...
                            <table className="w-full text-left border-collapse min-w-[800px]">
                                ...
                                <tbody className="divide-y divide-[#e5e7eb]">
                                    ...
                                    {filteredTickets.length === 0 && (
                                        <tr>
                                            <td colSpan={6} className="px-6 py-12 text-center text-[#60758a]">
                        ...
                        {filteredTickets.length > 0 && (
                            <div className="flex items-center justify-between px-6 py-4 border-t border-[#e5e7eb] bg-[#f8fafc]">
                                <p className="text-sm text-[#60758a]">
                                    Menampilkan <span className="font-medium text-[#111418]">1</span> sampai{' '}
                                    <span className="font-medium text-[#111418]">{Math.min(10, filteredTickets.length)}</span> dari{' '}
                                    <span className="font-medium text-[#111418]">{filteredTickets.length}</span> hasil
                                </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-2">
                        <div className="p-4 bg-white rounded-xl shadow-sm border border-[#e5e7eb]">
                            ...
                            <p className="text-2xl font-black text-[#111418]">{stats?.total_tickets || 0}</p>
                        </div>
                        <div className="p-4 bg-white rounded-xl shadow-sm border border-[#e5e7eb]">
                            <p className="text-xs font-bold text-[#60758a] uppercase tracking-wider mb-1">
                                Menunggu
                            </p>
                            <p className="text-2xl font-black text-[#111418]">{stats?.pending_tickets || 0}</p>
                        </div>
                        <div className="p-4 bg-white rounded-xl shadow-sm border border-[#e5e7eb]">
                            <p className="text-xs font-bold text-[#60758a] uppercase tracking-wider mb-1">
                                Diproses
                            </p>
                            <p className="text-2xl font-black text-primary">{stats?.in_progress_tickets || 0}</p>
                        </div>
                        <div className="p-4 bg-white rounded-xl shadow-sm border border-[#e5e7eb]">
                            <p className="text-xs font-bold text-[#60758a] uppercase tracking-wider mb-1">
                                Selesai
                            </p>
                            <p className="text-2xl font-black text-green-600">{stats?.resolved_tickets || 0}</p>
                        </div>
                    </div>
                </div>
            </main>
